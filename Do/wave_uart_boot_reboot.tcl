# Signals relevant to the reset/reboot stability test (2 rounds), then run.
#   xsim tb_soc_uart_boot_reboot_snap --gui --tclbatch Do/wave_uart_boot_reboot.tcl

set tb /tb_soc_uart_boot_reboot
